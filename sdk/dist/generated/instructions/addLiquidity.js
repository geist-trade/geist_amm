...
exports.addLiquidityInstructionDiscriminator = exports.addLiquidityStruct = void 0;
exports.createAddLiquidityInstruction = createAddLiquidityInstruction;
const splToken = __importStar(require("@solana/spl-token"));
const beet = __importStar(require("@metaplex-foundation/beet"));
const web3 = __importStar(require("@solana/web3.js"));
const AddLiquidityArgs_1 = require("../types/AddLiquidityArgs");
/**
 * @category Instructions
 * @category AddLiquidity
 * @category generated
 */
exports.addLiquidityStruct = new beet.FixableBeetArgsStruct([
    ['instructionDiscriminator', beet.uniformFixedSizeArray(beet.u8, 8)],
    ['args', AddLiquidityArgs_1.addLiquidityArgsBeet],
], 'AddLiquidityInstructionArgs');
exports.addLiquidityInstructionDiscriminator = [
